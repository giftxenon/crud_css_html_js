var newMemberAddBtn = document.querySelector(".addMemberBtn"),
  ...
  uploading = document.querySelector("#loading"),
...
newMemberAddBtn.addEventListener("click", () => {
  ...
  popupFooter.computedStyleMap.display = "block";
  imgInput.src = "./images/pass2.jpg";
...
uploading.onchange = function () {
  if (uploading.files[0].size < 1000000) {
    ...
    fileReader.readAsDataURL(uploading.files[0]);
  } else {
...
function showInfo(){
    document.querySelector(".employeeDetails").forEach(info.remove)
    ...
    <td>
       <button onclick = "readInfo('${staff.picture}', '${staff.fName}', 
       '${staff.lName}','${staff.AgeVal}','${staff.cityVal}',
       '${staff.positionVal}','${staff.salaryVal}', '${staff.sDateVal}',
       '${staff.emailVal}', '${staff.phoneVal}')"><i class="fa-regular fa-eye"></i></button>

       <button onclick = "editInfo('${i}','${staff.picture}', '${staff.fName}', 
       '${staff.lName}','${staff.AgeVal}','${staff.cityVal}',
       '${staff.positionVal}','${staff.salaryVal}', '${staff.sDateVal}',
       '${staff.emailVal}', '${staff.phoneVal}')"><i class="fa-regular fa-pen-to-square"></i></button>
       
       <button onclick = "deleteInfo('${i}','${staff.picture}', '${staff.fName}', 
       '${staff.lName}','${staff.AgeVal}','${staff.cityVal}',
       '${staff.positionVal}','${staff.salaryVal}', '${staff.sDateVal}',
       '${staff.emailVal}', '${staff.phoneVal}')"><i class="fa-regular fa-trash-can"></i></button>
    </td>
   </tr>`
   userInfo.innerHTML += createElement
   tableSize.style.minWidth = "1400px"
...
darkBg.classList.add('active'),
popupForm.classList.add('active')
popupFooter.computedStyleMap.display = "none"
modalTitle.innnerHTML ="Profile"
...
function editInfo(id, pic,fname, lname, Age, City, Position, Salary, SDate, Email, Phone){
    ...
    //find the index of the item to edit in the original data base on id
...
modalTitle.innnerHTML = "Update the Form"
...
form.addEventListener("submit", (e) => {
  ...
  const information = {
    id: Date.now(),
    picture: imgInput.src == undefined ? "./images/pass2.jpg" : imgInput.src,
    fname: fName.value,
    lName: lName.value,
    ageVal: age.value,
    cityVal: city.value,
